...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.83.03), February 05, 2016, at 10:23
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\jrkerlin\\Documents\\GitHub\\landkit\\Collection\\test2.psyexp',
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if text.status == STARTED:  # only update if being drawn
        text.setText(displaystring, log=False)
