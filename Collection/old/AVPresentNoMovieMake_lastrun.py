...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.83.03), February 05, 2016, at 10:27
...
expName = u'AVPresentNoMovieMake'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\jrkerlin\\Documents\\GitHub\\landkit\\Collection\\AVPresentNoMovieMake.psyexp',
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if speak_instruct.status == STARTED and t >= (0.0 + (5-win.monitorFramePeriod*0.75)): #most of one frame period left
        ...
        if t >= 0 and mic.status == NOT_STARTED:
            ...
            mic.status = STARTED
            mic.record(sec=5, block=False)  # start the recording thread
