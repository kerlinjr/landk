...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.83.03), February 05, 2016, at 14:15
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if mic.status == STARTED and not mic.recorder.running:
            mic.status = FINISHED
        if frameN == 5:
            videoclip = (VideoFileClip('C:\TCDTIMIT\s07F\straightcam\si621.mp4')
                        .fx( vfx.crop, x1=480, y1=64, x2=1440, y2=1024)
                        .fx( vfx.resize, width = 720))
            ...
            video.write_videofile('test1.mp4')
            movie.loadMovie('test1.mp4')
