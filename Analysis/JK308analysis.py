...
#sc.SpellCorrect()
#sc.ScoreWords()
dataDir = normjoin('C:\Experiments\JK308\dataOut')
tablePath = normjoin(r'C:\Experiments\JK308')
...
sc = landkit.SentCompare(list(lktable['FullSentence']),list(lktable['SourceSentence']),True,normjoin('C:\Experiments\JK308'))
