...
#sc.SpellCorrect()
#sc.ScoreWords()
dataDir = normjoin('C:\Experiments\JK307\dataOut')
tablePath = normjoin(r'C:\Experiments\JK307')
...
sc = landkit.SentCompare(list(lktable['TargetSentence']),list(lktable['SourceSentence']),True,normjoin('C:\Experiments\JK307'))
